...
class MoviesViewController: UIViewController, UISearchControllerDelegate {
    ...
    var viewModel: NowPlayingViewModelType!
    ...
    private func setupCollectionViewLayout() {
        ...
        let layout = MoviesFlowLayout(width: previewLayoutWidth, height: Constants.previewCellHeight)
    ...
    func makeDataSource() -> DataSource {
        let dataSource = DataSource(
            ...
            cellProvider: { (collectionView, indexPath, movie) ->
                ...
                cell.fill(with: MoviewCollectionCellViewModel(model: movie))
                return cell
        })
...
extension MoviesViewController: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let cell: MovieCollectionViewCell = collectionView.dequeueReusableCell(forIndexPath: indexPath)
        cell.update(with: MoviewCollectionCellViewModel(model: model))
        return cell
    }
}
